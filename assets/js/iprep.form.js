...
document.addEventListener('iprep.form.init', (e) => {
...
document.addEventListener('iprep.form.edit', ({detail}) => PopUp('iprep.form.edit', detail, {dialogueid: 'iprep-form-edit', dialogue_class: 'modal-popup-generic'}));
document.addEventListener('iprep.form.submit', doFormAction);
document.addEventListener('iprep.form.delete', doFormAction);

document.addEventListener('DOMContentLoaded', () => document.querySelector('form[name="js-iprep-list"]').onsubmit = (ev) => {
    ev.preventDefault();
